...
<html>
    ...
    <body>
        ...
        <div id="show-check" class="content scaffold-show" role="main">
            ...
            <f:display bean="check" />
            <g:form resource="${this.check}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.check}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
