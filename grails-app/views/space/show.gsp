...
<html>
    ...
    <body>
        ...
        <div id="show-space" class="content scaffold-show" role="main">
            ...
            <f:display bean="space" />
            <g:form resource="${this.space}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.space}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
